...
public class PTAccessibilityDemandBasedDrtOptimizer implements DrtOptimizer {
    private static final Logger log = LogManager.getLogger(PTAccessibilityDemandBasedDrtOptimizer.class);
    ...
    private final PastDemandAndAccessibilityBasedRebalancing rebalancingStrategy;
    ...
    public PTAccessibilityDemandBasedDrtOptimizer(DrtConfigGroup drtCfg, Fleet fleet, MobsimTimer mobsimTimer, DepotFinder depotFinder,
                                                  PastDemandAndAccessibilityBasedRebalancing rebalancingStrategy, DrtScheduleInquiry scheduleInquiry,
